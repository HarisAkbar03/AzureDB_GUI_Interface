...
Using Maven: Run the following commands to build and launch the app:
...
mvn clean install
mvn javafx:run
Using an IDE: Import the project into your IDE and run DB_GUI_Controller.java as a JavaFX application.
